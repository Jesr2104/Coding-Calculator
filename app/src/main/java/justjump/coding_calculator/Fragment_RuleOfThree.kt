 ...
 * Use the [Fragment_RuleOfThree.newInstance] factory method to
 * create an instance of this fragment.
 */
class Fragment_RuleOfThree : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment Fragment_RuleOfThree.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            Fragment_RuleOfThree().apply {
